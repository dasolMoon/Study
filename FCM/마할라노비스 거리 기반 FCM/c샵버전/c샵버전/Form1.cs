...
namespace c샵버전
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            chart1.ChartAreas["Draw"].AxisX.Maximum = 5;
            ...
            chart1.ChartAreas["Draw"].AxisY.Minimum = -1;
            ...
            for (i = 0; i < Class1.Clust; i++)
            {
                for (j = 0; j < Class1.Coordinates; j++)
                {
                    if (Class1.cw[j, i] == 1)
                    {
                        chart1.Series[i].Points.AddXY(Class1.Position[j, 0], Class1.Position[j, 1]);
                    }
                }
            }
            ...
            for (i = 0; i < Class1.Clust; i++)
            {
                chart1.Series["Center"].Points.AddXY(Class1.Cvector[i, 0], Class1.Cvector[i, 1]);
            }
        }
    }
}
