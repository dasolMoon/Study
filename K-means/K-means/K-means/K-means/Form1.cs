...
namespace K_means
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            chart1.ChartAreas["Draw"].AxisY.Maximum = 10;
            ...
            chart1.Series["Data"].Points.AddXY(Class1.x[4, 0], Class1.x[4, 1]);
            chart1.Series["Data"].Points.AddXY(Class1.x[5, 0], Class1.x[5, 1]);
            chart1.Series["Data"].Points.AddXY(Class1.x[6, 0], Class1.x[6, 1]);


            chart1.Series["Center"].Points.AddXY(Class1.v[0, 0], Class1.v[0, 1]);
            chart1.Series["Center"].Points.AddXY(Class1.v[1, 0], Class1.v[1, 1]);
            chart1.Series["Center"].Points.AddXY(Class1.v[2, 0], Class1.v[2, 1]);
            //chart1.Series["Center"].Points.AddXY(Class1.v[3, 0], Class1.v[3, 1]);
        }
    }   
}
