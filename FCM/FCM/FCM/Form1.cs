...
namespace FCM
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            chart1.ChartAreas["Draw"].AxisX.Minimum = Class1.xmin - 5;
            chart1.ChartAreas["Draw"].AxisX.Maximum = Class1.xmax + 5;
            chart1.ChartAreas["Draw"].AxisX.Interval = (Class1.xmax - Class1.xmin) / 5;
            ...
            chart1.ChartAreas["Draw"].AxisY.Minimum = Class1.ymin - 5;
            chart1.ChartAreas["Draw"].AxisY.Maximum = Class1.ymax + 5;
            chart1.ChartAreas["Draw"].AxisY.Interval = (Class1.ymax - Class1.ymin) / 5;
