...
namespace PFCM_R_m
{
    class InputData
    {
        ...
        public InputData()
        {
            data = new double[] { 1, 3, 1.5, 3.2, 1.3, 2.8, 3, 1 };
            /*{ 2,9,3,8,3,9,3,10,4,7,4,8,4,9,4,10,4,11,5,6,5,7,5,8,5,9,5,10,5,11,5,12,6,6,6,7,6,8,6,9,6
                                ,10,6,11,6,12,7,6,7,7,7,8,7,9,7,10,7,11,7,12,8,6,8,7,8,8,8,9,8,10,8,11,8,12,9,6,9,7,9
                                ,8,9,9,9,10,9,11,9,12,10,6,10,7,10,8,10,9,10,10,10,11,10,12,11,6,11,7,11,8,11,9,11,10
                                ,11,11,11,12,12,6,12,7,12,8,12,9,12,10,12,11,12,12,13,6,13,7,13,8,13,9,13,10,13,11,13
                                ,12,14,7,14,8,14,9,14,10,14,11,15,8,15,9,15,10,16,9};*/
